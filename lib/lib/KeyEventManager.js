...
class KeyEventManager {
  ...
  _callMatchingHandlerClosestToEventTarget(event, keyName, eventBitmapIndex, componentIndex) {
    ...
    const unmatchedHandlersStatus = indexFromEnd(this.unmatchedHandlerStatus, componentIndex);
        ...
        Object.keys(actions).forEach((actionName) => {
          ...
          if (handlerComponentIndexes) {
            ...
            handlerComponentIndexes.forEach((handlerComponentIndex) => {
              const handlerComponentStatus = indexFromEnd(this.unmatchedHandlerStatus, handlerComponentIndex);
