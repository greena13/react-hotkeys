...
class KeyEventManager {
  ...
  handleGlobalKeydown(event) {
    return this.globalEventStrategy.handleKeydown(event, this._getGlobalEventOptions());
  }

  handleGlobalKeypress(event) {
    return this.globalEventStrategy.handleKeypress(event, this._getGlobalEventOptions());
  }

  handleGlobalKeyup(event) {
    return this.globalEventStrategy.handleKeyup(event, this._getGlobalEventOptions());
  }
