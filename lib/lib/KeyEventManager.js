...
import FocusKeyEventStrategy from './strategies/FocusKeyEventStrategy';
...
class KeyEventManager {
  ...
  constructor(configuration = {}) {
    ...
    this.focusEventManager = new FocusKeyEventStrategy({ configuration, logger: this.logger });
    this.globalEventManager = new GlobalKeyEventStrategy({ configuration, logger: this.logger }, this);
  }
