...
class HotKeys extends Component {
  ...
  componentDidMount() {
    if (this.props.global) {
      this._globalIndex = this.constructor.getKeyEventManager().addGlobalHotKeys();
    }
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (this._isGlobalComponent()) {
       ...
       */
      this.constructor.getKeyEventManager().updateGlobalComponent(this._globalIndex, nextProps.keyMap, nextProps.handlers, this._getFocusOptions());
    } else {
  ...
  componentWillUnmount(){
    if (this._isGlobalComponent()) {
      this.constructor.getKeyEventManager().removeGlobalComponent(this._globalIndex)
    } else {
      this._handleBlur();
    }
  }
  ...
  _isGlobalComponent() {
    return !isUndefined(this._globalIndex);
  }
