...
class HotKeys extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (this._focused) {
      this.constructor.getKeyEventManager().updateComponent(this._getFocusTreeId(), this._componentIndex, nextProps.keyMap, nextProps.handlers);
    }
  }
  ...
  _handleFocus() {
    ...
    const [ focusTreeId, componentIndex ] = this.constructor.getKeyEventManager().handleFocus(this.props.keyMap, this.props.handlers);
  ...
  _handleKeyDown(event) {
    const discardFocusTreeId = this.constructor.getKeyEventManager().handleKeyDown(event, this._getFocusTreeId(), this._componentIndex);
  ...
  _handleKeyPress(event) {
    const discardFocusTreeId = this.constructor.getKeyEventManager().handleKeyPress(event, this._getFocusTreeId(), this._componentIndex);
   ...
   */
  _handleKeyUp(event) {
    const discardFocusTreeId = this.constructor.getKeyEventManager().handleKeyUp(event, this._getFocusTreeId(), this._componentIndex);
