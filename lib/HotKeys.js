 ...
 * @typedef {Object.<String, KeyEventMatcher>} KeyMap
 */
...
class HotKeys extends Component {
   ...
   * components
   * @returns {{hotKeyParent: HotKeys, hotKeyMap: KeyMap}} Child context object
   */
  getChildContext() {
    return {
      hotKeyParent: this,
   ...
   * in its ancestor.
   * @returns {KeyMap} This component's KeyMap merged with its HotKeys ancestor's
   */
  buildMap() {
   ...
   * @returns {KeyMap} This component's KeyMap
   */
  getMap() {
